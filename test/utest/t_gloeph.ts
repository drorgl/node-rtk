...
// import {time2str,geph_t,readrnx} from "../../binding/rtk";
...
// function dumpgeph(geph : geph_t[],  n : number) : void{
//     char s1[64],s2[64];
//     //int i;
//     for (let i=0;i<n;i++) {
...
// /* readrnx() */
// function utest1(){
//     let file1="../data/rinex/brdd0910.09g";
//     let file2="../data/rinex/brdc0910.09g";
//     nav_t nav={0};
...
// {
//     gtime_t time;
//     let  file ="../data/rinex/brdc0910.09g";
//     nav_t nav={0};
//     let  ep=[2009,4,1,0,0,0];
//     let tspan=86400.0,tint=30.0;
//     //,tow;
//     double rs[6],dts[2];
//     double var;
//     int i,sat,week,svh;
...
// }
// /* precise ephemeris */
// function utest4() : void{
//     gtime_t time;
//     let file="../data/sp3/igl15253.sp3";
//     nav_t nav={0};
//     let  ep=[2009,4,1,0,0,0];
//     let tspan=86400.0,tint=30.0
//     //,tow;
...
// }
// /* readsap() */
// function utest5() : void{
//     let file="../../data/igs05.atx",id[32];
//     let ep=[2009,4,1,0,0,0];
//     let time=epoch2time(ep);
//     nav_t nav={0};
//     //int i,stat;
...
// }
// /* satpos() */
// function utest6():void{
//     FILE *fp;
//     let file1="../data/rinex/brdc0910.09g";
//     let file2="../data/sp3/igl15253.sp3";
//     let file3="../../data/igs05.atx";
// /*
//     char *file4="../data/esa15253.sp3";
//     char *file5="../data/esa15253.clk";
// */
//     let outfile="testgloeph.out";
//     let ep=[2009,4,1,0,0,0];
//     let tspan=86400.0,tint=30.0;
//     //,tow;
