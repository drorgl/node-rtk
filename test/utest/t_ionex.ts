...
function dumptec(tec : tec_t,  n : number,  level : number):void{
    const tec_t *p;
    char s[64];
    int i,j,k,m;
...
function dumpdcb(nav :  nav_t) : void{
    //int i;
    printf("dcbs=\n");
...
/* readtec() */
function utest1() : void{
    let file1="../data/sp3/igrg3380.10j";
    let file2="../data/sp3/igrg3380.10i";
    let file3="../data/sp3/igrg33*0.10i";
    nav_t nav={0};
